$(function () {
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/market_advac/index/parent_id/8?page=' + txt;
        } else {
            window.location.href = '/market/market_advac/index/parent_id/8';
        }
    });

    //添加
    $('#btn_add').on('click', function () {
        location.href = '/market/market_advac/add';
    });
    //修改
    ...
    $("#btn_edit").click(function () {
        ...
        if (chk_value.length == 0) {
            ...
            // alert($('#page').val());
            window.location.href = '/market/market_advac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
        ...
        if (chk_value.length == 0) {
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    $.post('/market/market_advac/del', {id: chk_value.join(',')}, function (data) {
    ...
    $("#query_btn").click(function () {
        ...
        if (txt != '') {
            window.location.href = 'market/market_advac/index/parent_id/8' + "?key=" + txt;
        } else {
            window.location.href = 'market/market_advac/index/parent_id/8';
        }
