$(function () {
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/recordsac/index/parent_id/1?page=' + txt;
        } else {
            window.location.href = '/market/recordsac/index/parent_id/1';
        }
    });

    //添加
    $('#btn_add').on('click', function () {
        location.href = '/market/recordsac/add/';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            if(chk_value.length == 1){
                ...
                window.location.href = '/market/recordsac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
            }else{
    ...
    $("#btn_limit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/recordsac/edit_limit?id=' + chk_value[0] + '&parent_id='+$('.active').attr('data-pid');
        }
    });
    ...
    $("#btn_export").click(function () {
        window.location.href = '/market/recordsac/export';
    });
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = 'market/recordsac/index/parent_id/' + $('.active').attr('data-pid') + "?key=" + txt;
        } else {
            window.location.href = 'market/recordsac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
