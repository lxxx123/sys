$(function(){
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/yjy_advac/index/parent_id/90?page=' + txt;
        } else {
            window.location.href = '/market/yjy_advac/index/parent_id/90';
        }
    });
	...
	$('#btn_add').on('click',function () {
		location.href = '/market/yjy_advac/add';
    });
    //修改
    ...
    $("#btn_edit").click(function () {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/yjy_advac/edit'  + "?id=" + chk_value[0];
        }
    });
        ...
        if (chk_value.length == 0) {
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
					$.post('/market/yjy_advac/del',{id:chk_value.join(',')},function(data){
	...
	$("#query_btn").click(function(){
		...
		if(txt != ''){
			window.location.href = 'market/yjy_advac/index/parent_id/90'+"?key="+txt;
		}else{
			window.location.href = 'market/yjy_advac/index/parent_id/90';
		}
