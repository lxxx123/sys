$(function(){
    ...
    $("#btn_export").click(function () {
    	window.location.href = '/market/destroy_logac/export'; 
    });
    //全选，全不选
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/destroy_logac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/destroy_logac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
	...
	$("#btn_search").click(function(){
		...
		if(txt != ''){
			window.location.href = '/market/destroy_logac/index/parent_id/' + $('.active').attr('data-pid') + "?key=" + txt;
		}else{
			window.location.href = '/market/destroy_logac/index/parent_id/' + $('.active').attr('data-pid');
		}	
	});
	...
	$("#btn_add").click(function(){
			...
			window.location.href = '/market/destroy_logac/add';	
	});	
    //删除
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/destroy_logac/del" ,//url
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            // alert(chk_value[0]);
            window.location.href = '/market/destroy_logac/edit/id/' + chk_value[0];
        }
    });
});