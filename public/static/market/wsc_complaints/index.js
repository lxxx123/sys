$(function(){
  ...
  /*  $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/wsc_complaintsac/index/parent_id/139?page=' + txt;
        } else {
            window.location.href = '/market/wsc_complaintsac/index/parent_id/139';
        }
    });
*/
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/wsc_complaintsac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/wsc_complaintsac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
	//添加
  ...
  /*  var tipsTimer1;//在外部定义延迟函数变量名
    $("#btn_edit").click(function () {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/wsc_complaintsac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });*/
  ...
  /*  $('#check-all').on('change', function () {
	...
	/*$("#query_btn").click(function(){
		...
		if(txt != ''){
			window.location.href = 'market/wsc_complaintsac/index/parent_id/139'+"?key="+txt;
		}else{
			window.location.href = 'market/wsc_complaintsac/index/parent_id/139';
		}
	});*/
    ...
    $("#query_btn").click(function(){
        var txt = $("#cate_name").val();
        if(txt != ''){
            window.location.href = 'market/wsc_complaintsac/index/parent_id/'+ $('.active').attr('data-pid')+"?key="+txt;
        }else{
            window.location.href = 'market/wsc_complaintsac/index/parent_id/'+ + $('.active').attr('data-pid');
        }
    });
