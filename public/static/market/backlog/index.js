$(function () {
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/backlogac/index/parent_id/11?page=' + txt;
        } else {
            window.location.href = '/market/backlogac/index/parent_id/7';
        }
    });
   ...
   /* $("#btn_export").click(function () {
    ...
    $('#btn_add').on('click', function () {
        location.href = '/market/backlogac/add/';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/backlogac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = 'market/backlogac/index/parent_id/' + $('.active').attr('data-pid') + "?key=" + txt;
        } else {
            window.location.href = 'market/backlogac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
