$(function(){
	...
	$('#btn_add').on('click',function () {
		location.href = '/market/work_positionac/add';
    });
    //修改
    ...
    $("#btn_edit").click(function () {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/work_positionac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
        ...
        if (chk_value.length == 0) {
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
					...
					$.post('/market/work_positionac/del',{id:chk_value.join(',')},function(data){
