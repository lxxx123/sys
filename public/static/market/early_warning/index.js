$(function(){
    ...
    $("#btn_export").click(function () {
    	window.location.href = '/market/early_warningac/export'; 
    });
	...
	$("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/early_warningac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/early_warningac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });

    //添加
    $("#btn_add").click(function () {
        location.href ='/market/early_warningac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/early_warningac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
	...
	$("#btn_search").click(function(){
		...
		if(txt != ''){
			window.location.href = '/market/early_warningac/index/parent_id/' + $('.active').attr('data-pid') + "?key="+txt;
		}else{
			window.location.href = '/market/early_warningac/index/parent_id/' + $('.active').attr('data-pid');
		}
	});
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/early_warningac/del" ,//url
