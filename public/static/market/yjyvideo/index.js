$(function () {
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = '/market/yjy_videoac/index/parent_id/84'  + '?key=' + txt;
        } else {
            window.location.href = '/market/yjy_videoac/index/parent_id/84';
        }
    });
    ...
    $('#btn_add').on('click', function () {
        location.href = '/market/yjy_videoac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/yjy_videoac/edit'+ "?id=" + chk_value[0];
        }
    });
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/yjy_videoac/del" ,//url
