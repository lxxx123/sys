$(function(){
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/merchantac/index/parent_id/3?page=' + txt;
        } else {
            window.location.href = '/market/merchantac/index/parent_id/3';
        }
    });
    ...
    $("#btn_edit").click(function () {
        ...
        if (chk_value.length == 0) {
            ...
            // alert($('#page').val());
            window.location.href = '/market/merchantac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
	...
	$("#query_btn").click(function(){
		...
		if(txt != ''){
			window.location.href = '/market/merchantac/index/parent_id/3'+"?key="+txt;
		}else{
			window.location.href = '/market/merchantac/index/parent_id/3';
		}
