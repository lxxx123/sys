$(function () {
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/big_dataac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/big_dataac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = '/market/big_dataac/index/parent_id/21'  + '?key=' + txt;
        } else {
            window.location.href = '/market/big_dataac/index/parent_id/21';
        }
    });
    ...
    $('#btn_add').on('click', function () {
        location.href = '/market/big_dataac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/big_dataac/edit'+ "?id=" + chk_value[0];
        }
    });
