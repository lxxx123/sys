$(function () {
    ...
    //     var txt = $("#page").val();
    //     if (txt != '') {
    //         window.location.href = '/market/supplierac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
    //     } else {
    //         window.location.href = '/market/supplierac/index/parent_id/' + $('.active').attr('data-pid');
    //     }
    // });
    ...
    //     if (txt != '') {
    //         window.location.href = '/market/supplierac/index/parent_id/' + $('.active').attr('data-pid') + '?key=' + txt;
    //     } else {
    //         window.location.href = '/market/supplierac/index/parent_id/' + $('.active').attr('data-pid');
    //     }
    // });
    ...
    //     window.location.href = '/market/supplierac/export';
    // });

    //添加
    $('#btn_add').on('click', function () {
        location.href = '/market/sx_bannerac/add/parent_id/' + $('.active').attr('data-pid');
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/sx_bannerac/edit/parent_id/' + $('.active').attr('data-pid')+ "?id=" + chk_value[0];
        }
    });
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/sx_bannerac/del" ,//url
