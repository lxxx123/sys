$(function () {
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/zz_quick_goods_inac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/zz_quick_goods_inac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = '/market/zz_quick_goods_inac/index/parent_id/' + $('.active').attr('data-pid') + '?key=' + txt;
        } else {
            window.location.href = '/market/zz_quick_goods_inac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
    ...
    $('#btn_add').on('click', function () {
        location.href = '/market/zz_quick_goods_inac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/zz_quick_goods_inac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/zz_quick_goods_inac/del" ,//url
