$(function () {
    ...
    $("#to_submit").click(function(){
        ...
        $.post('/market/jxuserac/edit_post',{id:id,page:page,password:password,username:username,account_number:account_number,position_id:position_id},function(data){
            if(data==1){
                alert('修改成功');
