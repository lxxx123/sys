$(function(){
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/goods_inac/index/parent_id/4?page=' + txt;
        } else {
            window.location.href = '/market/goods_inac/index/parent_id/4';
        }
    });
	...
	$('#btn_add').on('click',function () {
		location.href = '/market/goods_inac/add';
    });
    //修改
    ...
    $("#btn_edit").click(function () {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/goods_inac/edit/id/' + chk_value[0];
        }
    });
        ...
        if (chk_value.length == 0) {
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
					$.post('/market/goods_inac/del',{id:chk_value.join(',')},function(data){
						if(data=1){
							window.location.href = '/market/goods_inac/index/parent_id/4';
						}else{
	...
	$("#query_btn").click(function(){
		...
		if(txt != ''){
			window.location.href = '/market/goods_inac/index/parent_id/4'+"?key="+txt;
		}else{
			window.location.href = '/market/goods_inac/index/parent_id/4';
		}
	});
