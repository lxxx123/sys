$(function () {    
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/yjy_institutionac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/yjy_institutionac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = '/market/yjy_institutionac/index/parent_id/' + $('.active').attr('data-pid') + '?key=' + txt;
        } else {
            window.location.href = '/market/yjy_institutionac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
    ...
    $("#btn_add").click(function () {
        location.href ='/market/yjy_institutionac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/yjy_institutionac/edit' + "?id=" + chk_value[0];
        }
    });

    //导出Excel
    $("#btn_export").click(function () {
    	window.location.href = '/market/yjy_institutionac/export';
    });
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/yjy_institutionac/del" ,//url
