$(function(){
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/sx_goods_managementac/index/parent_id/8?page=' + txt;
        } else {
	...
	$('#btn_add').on('click',function () {
		location.href = '/market/sx_goods_managementac/add/parent_id/'+ $('.active').attr('data-parent');
    });
    ...
    $("#btn_edit").click(function () {
        ...
        if (chk_value.length == 0) {
            ...
            location.href = '/market/sx_goods_managementac/edit/parent_id/' + $('.active').attr('data-parent') + "?id=" + chk_value[0];
        }
    });
        ...
        if (chk_value.length == 0) {
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
					$.post('/market/sx_goods_managementac/del',{id:chk_value.join(',')},function(data){
						if(data.status==1){
