$(function () {    
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/yjy_circularac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/yjy_circularac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = '/market/yjy_circularac/index/parent_id/' + $('.active').attr('data-pid') + '?key=' + txt;
        } else {
            window.location.href = '/market/yjy_circularac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
    ...
    $("#btn_add").click(function () {
        location.href ='/market/yjy_circularac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/yjy_circularac/edit' + "?id=" + chk_value[0];
        }
    });

    //导出Excel
    $("#btn_export").click(function () {
    	window.location.href = '/market/yjy_circularac/export';
    });
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/yjy_circularac/del" ,//url
