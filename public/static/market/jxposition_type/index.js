$(function(){
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        window.location.href = '/market/jxposition_typeac/index/parent_id/' +$('.active').attr('data-parent')+ '?page=' + txt;
    });

	//添加
	$('#btn_add').on('click',function () {
		location.href = '/market/jxposition_typeac/add';
    });
    ...
    $("#btn_edit").click(function () {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/jxposition_typeac/edit?id=' + chk_value[0];
        }
    });
        ...
        if (chk_value.length == 0) {
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
					...
					$.post('/market/jxposition_typeac/del',{id:chk_value.join(',')},function(data){

						if(data==1){
							window.location.href = '/market/jxposition_typeac/index/parent_id/2';
						}else{
