$(function () {    
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = '/market/guidelineac/index/parent_id/' + $('.active').attr('data-pid') + '?key=' + txt;
        } else {
            window.location.href = '/market/guidelineac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
    ...
    $("#btn_add").click(function () {
        location.href ='/market/guidelineac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/guidelineac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/guidelineac/del" ,//url
