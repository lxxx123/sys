$(function(){	
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/activitiesac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/activitiesac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });

    //添加
    $("#btn_add").click(function () {
        location.href ='/market/activitiesac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/activitiesac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
	...
	$("#btn_search").click(function(){
		...
		if(txt != ''){
			window.location.href = '/market/activitiesac/index/parent_id/' + $('.active').attr('data-pid') + "?key="+txt;
		}else{
			window.location.href = '/market/activitiesac/index/parent_id/' + $('.active').attr('data-pid');
		}
	});
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: "/market/activitiesac/del" ,//url
