$(function(){
  ...
  /*  $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/wsc_ucenterac/index/parent_id/139?page=' + txt;
        } else {
            window.location.href = '/market/wsc_ucenterac/index/parent_id/139';
        }
    });*/
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/wsc_ucenterac/index/parent_id/' + $('.active').attr('data-pid') + '?page=' + txt;
        } else {
            window.location.href = '/market/wsc_ucenterac/index/parent_id/' + $('.active').attr('data-pid');
        }
    });
	//添加
        ...
        if (chk_value.length == 0) {
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
					...
					$.post('/market/wsc_ucenterac/del',{id:chk_value.join(',')},function(data){
...
/*	$("#query_btn").click(function(){
		...
		if(txt != ''){
			window.location.href = 'market/wapp_userac/index/parent_id/117'+"?key="+txt;
		}else{
