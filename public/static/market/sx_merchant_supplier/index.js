$(function(){
	...
	$('#btn_add').on('click',function () {
		location.href = '/market/sx_merchant_supplierac/add/parent_id/' + $('.active').attr('data-parent')+"?page="+$('#page').val();
    });
    //修改
	...
	$("#query_btn").click(function(){
        ...
        // alert(123);
		if(txt != ''){
			window.location.href = '/market/sx_merchant_supplierac/index/parent_id/'+$('.active').attr('data-parent')+"?key="+txt;
		}else{
			window.location.href = '/market/sx_merchant_supplierac/index/parent_id/'+ $('.active').attr('data-parent');
		}
