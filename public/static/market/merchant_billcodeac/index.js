$(function () {
    ...
    laydate({
        ...
        choose: function (date) {
             window.location.href = '/market/merchant_bill_codeac/index/parent_id/94?date=' + date;
        }
    });
    ...
    $('#query-btn').on('click', function () {
        // query($('#bill_dt1').val());
         window.location.href = '/market/merchant_bill_codeac/index/parent_id/94?bill_dt1=' +$('#bill_dt1').val();
    });
    ...
    $('#prev-btn').on('click', function () {
        ...
        //查询
        window.location.href = '/market/merchant_bill_codeac/index/parent_id/94?date=' +prevDay;
    });
    ...
    $('#today-btn').on('click', function () {
        //查询
         ...
         window.location.href = '/market/merchant_bill_codeac/index/parent_id/94?date=' +formatDate(new Date());
    });
    ...
    $('#next-btn').on('click', function () {
        ...
        //查询
        window.location.href = '/market/merchant_bill_codeac/index/parent_id/94?date=' +nextDay;
    });
    ...
    $('#go').on('click', function () {
        ...
        if (isNaN(page)) {
           ...
           window.location.href = '/market/merchant_bill_codeac/index/parent_id/94?page=' +page;
        }
    });
