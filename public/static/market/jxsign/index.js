$(function () {
    function query(date, page) {
        ...
        var url = '/market/jxsignac/count/parent_id/' + $('.active').attr('data-parent');
    ...
    $('#prev-btn').on('click', function () {
        ...
        var currentDay = $('#jxsign').val() === '' ? formatDate(new Date()) : $('#jxsign').val();
    ...
    $('#export-btn').on('click', function () {
       var date = $('#jxsign').val() === '' ? formatDate(new Date()) : $('#jxsign').val();
       location.href = '/market/jxsignac/export/dates/'+date;
    });
