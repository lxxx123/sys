$(function () {
    ...
    $("#sure").click(function () {
        var txt = $("#page").val();
        if (txt != '') {
            window.location.href = '/market/check_alreadyac/index/parent_id/4' + '?page=' + txt;
        } else {
            window.location.href = '/market/check_alreadyac/index/parent_id/4';
        }
    });
    ...
    $("#btn_search").click(function () {
        ...
        if (txt != '') {
            window.location.href = '/market/check_alreadyac/index/parent_id/4' + '?key=' + txt;
        } else {
            window.location.href = '/market/check_alreadyac/index/parent_id/4';
        }
    });
    ...
    $("#btn_export").click(function () {
        window.location.href = '/market/check_alreadyac/export';
    });
    ...
    $('#btn_add').on('click', function () {
        location.href = '/market/goodsac/add';
    });
    ...
    $("#btn_edit").click(function (ev) {
        ...
        if (chk_value.length == 0) {
            ...
            window.location.href = '/market/check_alreadyac/edit/page/' + $('#page').val() + "?id=" + chk_value[0];
        }
    });
        ...
        if (chk_value.length == 0) {
            ...
            $('.confirm').fadeIn(function () {
                ...
                $('#del-confirm').on('click', function () {
                    $.post('/market/check_alreadyac/del',{id:chk_value.join(',')},function(data){
